...
public abstract class GamePlayer
{
	...
	// amity code
	public GameFrame frame = new GameFrame("Frame", new HexCanvas());
	{
		frame.setTitle("Amity Observation Panel");
	...
	public Params tournamentParams = new Params("config/tournament.txt");
	 ...
	 */
	public abstract GameMove getMove(GameState state, String lastMv);
		...
		try
		{
			...
			while (true)
			{
				...
				else if (cmd.equals("MOVE"))
				{
					...
					// AMITY CODE
					frame.canvas.setBoard(gameState);
